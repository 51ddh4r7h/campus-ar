...
export const SESSION_ERRORS = {
  ...
  replay_pending: 'An organiser is already looking at your request.',
  replay_cooling_down: "It's too soon to ask again — give it a few minutes.",
  replay_not_approved: 'An organiser needs to approve this first.',
